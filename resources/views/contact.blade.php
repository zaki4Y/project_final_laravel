                ...
                <div class="lg:mb-0 mb-10">
                    <div class="group w-full h-full">
                        <div class="relative h-full">
                            ...
                            <h1 class="font-manrope text-white text-4xl font-bold leading-10 absolute top-11 left-11">Contact
                                us</h1>
                            <div class="absolute bottom-0 w-full lg:p-11 p-5">
                                <div class="bg-white rounded-lg p-6 block">
                                    ...
                                    <a href="javascript:;" class="flex items-center mb-6">
                                        ...
                                        <h5 class="text-black text-base font-normal leading-6 ml-5">Pagedone1234@gmail.com
                                        </h5>
                                    </a>
