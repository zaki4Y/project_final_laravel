                    ...
                    <div class="flex space-x-4">
                        ...
                        <div class="hidden md:flex items-center space-x-1">
                            <a href="{{ route('contact') }}"
                                class="py-5 px-3 text-gray-700 hover:text-gray-900 font-[Montserrat]">CONTACT US</a>
                            <a href="{{ route('about') }}"
                                class="py-5 px-3 text-gray-700 hover:text-gray-900 font-[Montserrat]">ABOUT</a>
                            <a href="{{ route('reservation') }}"
                                class="py-5 px-3 text-gray-700 hover:text-gray-900 font-[Montserrat]">RESERVATION</a>
            ...
            <div class="w-full bg-center bg-cover h-[38rem]"
                ...
                <div class="flex items-center justify-center w-full h-full bg-gray-900/40">
                    <div class="text-center">
                        <h1 class="text-3xl font-semibold text-white lg:text-4xl font-[Montserrat-b]">Build Your New
                            <span class="text-blue-400 font-[SpaceMono-i] ">CO WORK</span> Project
                        </h1>
                        <a href="/reservation">

                            <button
                                class="w-full px-5 py-2 mt-4 text-sm font-medium text-white capitalize transition-colors duration-300 transform bg-blue-600 rounded-md lg:w-auto hover:bg-blue-500 focus:outline-none focus:bg-blue-500 clickMe font-[Montserrat-r] ">Book
                                Now</button>
                        </a>
        ...
        <section>
                ...
                <div class="container mx-auto px-4">
                    ...
                    <div class="flex flex-wrap items-center mt-16">
                        <div class="w-full md:w-5/12 px-4 mr-auto ml-auto">
                            ...
                            <h3 class="text-3xl mb-2 font-[Montserrat-b]  leading-normal">
                                Working with us is a pleasure
                            </h3>
                            <p class="text-lg font-light leading-relaxed mt-4 mb-4 text-blueGray-600 font-[OpenSans-b]">

                                Working with us is a pleasure because our team is passionate, collaborative, and always
                                goes the extra mile to ensure your satisfaction. We foster a transparent and efficient
                                work environment, prioritizing clear communication and a results-oriented approach. This
                                dedication translates into a seamless and successful experience for you.
                            </p>
                        ...
                        <div class="w-full md:w-4/12 px-4 mr-auto ml-auto">
                            <div
                                class="relative flex flex-col min-w-0 break-words  w-full mb-2 shadow-lg rounded-lg bg-pink-500">
                                <img alt="..."
                                ...
                                <blockquote class="relative p-8 mb-4">
                                    ...
                                    <h4 class="text-xl font-bold text-white font-[Montserrat-b]">
                                        Top Notch Services
                                    </h4>
                                    <p class="text-md font-light mt-2 text-white font-[OpenSans-b]">

                                        Our coworking space redefines top-notch service. Experience unparalleled
                                        security and dedicated community management alongside personalized workspace
                                        options and premium amenities like cafes and fitness centers. Thrive in a space
                ...
                <div class="bg-blueGray-200  font-[sans-serif] p-4">
                    <div class="max-w-7xl mx-auto">
                        <div class="text-center max-w-xl mx-auto">
                            <h2 class="text-3xl font-extrabold text-[#333] inline-block font-[Montserrat-b]">LATEST
                                BLOGS</h2>
                            <p class="text-gray-600 mt-6 text-xl font-[OpenSans-b]  ">
                                Stay ahead of the curve and foster a thriving work life! Explore our latest blog posts,
                                packed with actionable tips and inspiring stories from our coworking community. Discover
                                expert advice on maximizing productivity, solutions to common workspace challenges, and
                                the many benefits of joining our collaborative environment.
                            </p>
                        </div>
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-12 max-md:max-w-lg mx-auto">
                            <div
                                class="bg-white cursor-pointer rounded overflow-hidden group relative before:absolute before:inset-0 before:z-10 before:bg-black before:opacity-50">
                                ...
                                <div class="p-6 absolute bottom-0 left-0 right-0 z-20">
                                    <span class="text-sm block mb-2 text-yellow-400 font-semibold">10 FEB 2023 | BY JOHN
                                        DOE</span>
                                    <h3 class="text-xl font-bold text-white">A Guide to Igniting Your Imagination</h3>
                                    <div class="mt-4">
                                        <p class="text-gray-200 text-sm ">Lorem ipsum dolor sit amet, consectetur
                                            adipiscing elit. Duis accumsan, nunc et tempus blandit, metus mi consectetur
                                            felis turpis vitae ligula.</p>
                                    </div>
                                </div>
                            </div>
                            <div
                                ...
                                <img src="https://readymadeui.com/hacks-watch.webp" alt="Blog Post 2"
                                    class="w-full h-96 object-cover group-hover:scale-110 transition-all duration-300" />
                                <div class="p-6 absolute bottom-0 left-0 right-0 z-20">
                                    <span class="text-sm block mb-2 text-yellow-400 font-semibold">7 JUN 2023 | BY MARK
                                        ADAIR</span>
                            ...
                            <div
                                ...
                                <img src="https://readymadeui.com/prediction.webp" alt="Blog Post 3"
                                    class="w-full h-96 object-cover group-hover:scale-110 transition-all duration-300" />
                                <div class="p-6 absolute bottom-0 left-0 right-0 z-20">
                                    <span class="text-sm block mb-2 text-yellow-400 font-semibold">5 OCT 2023 | BY
                                        SIMON KONECKI</span>
            ...
            <section class="py-10">
                <div class="flex justify-center items-center">
                    ...
                    <div
                        class="font-[sans-serif] text-white bg-gradient-to-r from-purple-800 to-indigo-800 py-12 px-4 w-[90vw]">
                        <div class="max-w-7xl mx-auto">
                            <h2 class="sm:text-4xl text-2xl font-extrabold text-center mb-16 font-[Montserrat-b]">
                            ...
                            <div class="grid lg:grid-cols-3 md:grid-cols-2 gap-12 max-md:max-w-lg mx-auto">
                                <div
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                        class="w-8 mb-4 inline-block" viewBox="0 0 32 32">
                                        <path
                                    ...
                                    <p class="text-gray-300 group-hover:text-gray-500 text-sm"> Stay connected and
                                        upload with ease thanks to our blazing-fast and reliable internet connection..
                                    </p>
                                </div>
                                <div
                                    class="rounded-xl group p-8 text-center hover:bg-white hover:text-purple-800 hover:shadow-xl transition duration-300">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                        class="w-8 mb-4 inline-block" viewBox="0 0 682.667 682.667">
                                        <defs>
                                    ...
                                    <p class="text-gray-300 group-hover:text-gray-500 text-sm">The coworking space
                                        should have strong Wi-Fi encryption and data security protocols in place.</p>
                                </div>
                                <div
                                    class="rounded-xl group p-8 text-center hover:bg-white hover:text-purple-800 hover:shadow-xl transition duration-300">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                        class="w-8 mb-4 inline-block" viewBox="0 0 512.001 512.001">
                                        <path
                                    ...
                                    <p class="text-gray-300 group-hover:text-gray-500 text-sm"> Get access to exclusive
                                        discounts on business services, educational resources, and health and wellness
                                        programs..</p>
                                </div>
                                <div
                                    class="rounded-xl group p-8 text-center hover:bg-white hover:text-purple-800 hover:shadow-xl transition duration-300">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                        class="w-8 mb-4 inline-block" viewBox="0 0 24 24">
                                    ...
                                    <p class="text-gray-300 group-hover:text-gray-500 text-sm">Work when you're most
                                        productive, with after-hours and weekend access to our facilities.</p>
                                </div>
                                <div
                                    class="rounded-xl group p-8 text-center hover:bg-white hover:text-purple-800 hover:shadow-xl transition duration-300">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                        class="w-8 mb-4 inline-block" viewBox="0 0 504.69 504.69">
                                        <path
                                    ...
                                    <p class="text-gray-300 group-hover:text-gray-500 text-sm">We offer a variety of
                                        workspaces to suit your needs.</p>
                                </div>
                                <div
                                    class="rounded-xl group p-8 text-center hover:bg-white hover:text-purple-800 hover:shadow-xl transition duration-300">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                        ...
                                        <g fill="none" stroke="currentColor" stroke-miterlimit="10"
                                            stroke-width="30" clip-path="url(#a)"
                                    ...
                                    <p class="text-gray-300 group-hover:text-gray-500 text-sm"> Connect with
                                        like-minded professionals at our regular workshops, social gatherings, and
                                        industry-specific events..</p>
                                </div>
                            </div>
                        </div>
                    </div>
